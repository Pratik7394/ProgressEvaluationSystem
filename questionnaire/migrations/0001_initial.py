    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Defence_Status', models.CharField(choices=[('Expected', 'Expected'), ('Passed', 'Passed'), ('Not Passed', 'Not Passed')], default='Expected', max_length=10)),
                ('Thesis_Committee', models.TextField(blank=True, max_length=5000)),
                ('Current_GPA', models.FloatField(null=True, validators=[django.core.validators.MaxValueValidator(4)])),
