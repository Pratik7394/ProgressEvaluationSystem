# Generated by Django 2.1.7 on 2019-04-23 22:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Coauthor', models.CharField(blank=True, max_length=1000)),
                ('Author', models.ForeignKey(db_column='name', on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='qualifyingExam',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Current_GPA', models.FloatField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(4)])),
